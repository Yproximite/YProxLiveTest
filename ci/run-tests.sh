...
rm -Rf output/*
php bin/test.php test:response-time --write-errors="$OUTPUT_DIR/errors.log" --write-response-times="$OUTPUT_DIR/response.log" http://admin.plombierweb.fr/platformmap.xml
